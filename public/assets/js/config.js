$(document).ready(function() {
    ...
    if ($("#estado_cidade").length) {

        if($('#msg').length){
            $('#msg').fadeOut(3000);
        }

        $('#btn_save_institutions').click(function(){
            var nome   = $('#nome').val();
            var rua    = $('#rua').val();
            ...
            if(nome == '' || nome == null){
                ...
                $('#error').html('Necessário preencher o nome corretamente!');
                $('#error').fadeOut(3500);
              ...
              $('#error').html('');
                $('#error').removeClass('d-none');
                $('#error').html('Necessário preencher a rua corretamente!');
                $('#error').fadeOut(3500);
              ...
              $('#error').html('');
                $('#error').removeClass('d-none');
                $('#error').html('Necessário preencher o bairro corretamente!');
                $('#error').fadeOut(3500);
              ...
              $('#error').html('');
                $('#error').removeClass('d-none');
                $('#error').html('Necessário preencher o Estado corretamente!');
              ...
              $('#error').html('');
                $('#error').removeClass('d-none');
                $('#error').html('Necessário preencher cidade corretamente!');
                $('#error').fadeOut(3500);
                ...
                $('#novo-cadastro-instituicao').submit();
        ...
        $(() => {
            $('#uf').on('change', () => {
                var estado = $('#uf').val();              // pega o valor selecionado
        ...
        function mostraCidade(estado) {
            for (let i = 0; i < dados.length; i++) {         // percorre o array principal
                ...
                if (dados[i].sigla == estado) {                // pega o estado conforme a seleção
                    ...
                    cidade_ = dados[i].cidades;                   // guarda as cidades respectivas
                    for (let y = 0; y < cidade_.length; y++)      // percorre as cidades respectivas
                        cidades.append($('<option>', {             // cria as tags option
                        text: cidade_[y]                          // insere as cidades nos options
                    }))
                }
            }
        }
